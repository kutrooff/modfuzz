...
class JsonReporter:
    ...
    def export(self, results, findings_counter, mode: str, output_dir="reports/json"):
    ...
    def _serialize_result(self, result):
        ...
        return {
            ...
            "path": result.case.endpoint.path,
            "iteration": result.iteration,
            "scenario_id": result.scenario_id,
            "scenario_step": result.scenario_step,
            ...
            "request": {
                ...
                "headers": result.case.headers,
                "body": result.case.body,
            },
            "response": {"body": result.response_body, "error": result.error},
        }
